...
var _pairshaped$elm_firebase$Firebase$options = _pairshaped$elm_firebase$Native_Firebase.options;
var _pairshaped$elm_firebase$Firebase$name = _pairshaped$elm_firebase$Native_Firebase.name;
var _pairshaped$elm_firebase$Firebase$deinit = _pairshaped$elm_firebase$Native_Firebase.deinit;
var _pairshaped$elm_firebase$Firebase$initWithName = _pairshaped$elm_firebase$Native_Firebase.initWithName;
var _pairshaped$elm_firebase$Firebase$init = _pairshaped$elm_firebase$Native_Firebase.init;
var _pairshaped$elm_firebase$Firebase$apps = _pairshaped$elm_firebase$Native_Firebase.apps;
var _pairshaped$elm_firebase$Firebase$sdkVersion = _pairshaped$elm_firebase$Native_Firebase.sdkVersion;
var _pairshaped$elm_firebase$Firebase$Config = F5(
	function (a, b, c, d, e) {
		return {apiKey: a, authDomain: b, databaseURL: c, storageBucket: d, messagingSenderId: e};
	});
var _pairshaped$elm_firebase$Firebase$App = {ctor: 'App'};

var _pairshaped$elm_firebase$Firebase_Errors$WebStorageUnsupported = {ctor: 'WebStorageUnsupported'};
var _pairshaped$elm_firebase$Firebase_Errors$UserTokenExpired = {ctor: 'UserTokenExpired'};
var _pairshaped$elm_firebase$Firebase_Errors$UnauthorizedDomain = {ctor: 'UnauthorizedDomain'};
var _pairshaped$elm_firebase$Firebase_Errors$TooManyRequests = {ctor: 'TooManyRequests'};
var _pairshaped$elm_firebase$Firebase_Errors$RequiresRecentLogin = {ctor: 'RequiresRecentLogin'};
var _pairshaped$elm_firebase$Firebase_Errors$OperationNotAllowed = {ctor: 'OperationNotAllowed'};
var _pairshaped$elm_firebase$Firebase_Errors$NetworkRequestFailed = {ctor: 'NetworkRequestFailed'};
var _pairshaped$elm_firebase$Firebase_Errors$InvalidUserToken = {ctor: 'InvalidUserToken'};
var _pairshaped$elm_firebase$Firebase_Errors$InvalidApiKey = {ctor: 'InvalidApiKey'};
var _pairshaped$elm_firebase$Firebase_Errors$ArgumentError = {ctor: 'ArgumentError'};
var _pairshaped$elm_firebase$Firebase_Errors$AppNotAuthorized = {ctor: 'AppNotAuthorized'};
var _pairshaped$elm_firebase$Firebase_Errors$AppDeleted = {ctor: 'AppDeleted'};

var _pairshaped$elm_firebase$Firebase_Authentication_Types$Auth = {ctor: 'Auth'};
var _pairshaped$elm_firebase$Firebase_Authentication_Types$User = {ctor: 'User'};
...
var _pairshaped$elm_firebase$Firebase_Authentication$verifyPasswordResetCode = _pairshaped$elm_firebase$Native_Authentication.verifyPasswordResetCode;
var _pairshaped$elm_firebase$Firebase_Authentication$signOut = _pairshaped$elm_firebase$Native_Authentication.signOut;
var _pairshaped$elm_firebase$Firebase_Authentication$signInWithEmailAndPassword = _pairshaped$elm_firebase$Native_Authentication.signInWithEmailAndPassword;
var _pairshaped$elm_firebase$Firebase_Authentication$signInAnonymously = _pairshaped$elm_firebase$Native_Authentication.signInAnonymously;
var _pairshaped$elm_firebase$Firebase_Authentication$sendPasswordResetEmail = _pairshaped$elm_firebase$Native_Authentication.sendPasswordResetEmail;
var _pairshaped$elm_firebase$Firebase_Authentication$fetchProvidersForEmail = _pairshaped$elm_firebase$Native_Authentication.fetchProvidersForEmail;
var _pairshaped$elm_firebase$Firebase_Authentication$createUserWithEmailAndPassword = _pairshaped$elm_firebase$Native_Authentication.createUserWithEmailAndPassword;
var _pairshaped$elm_firebase$Firebase_Authentication$confirmPasswordReset = _pairshaped$elm_firebase$Native_Authentication.confirmPasswordReset;
var _pairshaped$elm_firebase$Firebase_Authentication$currentUser = _pairshaped$elm_firebase$Native_Authentication.currentUser;
var _pairshaped$elm_firebase$Firebase_Authentication$init = _pairshaped$elm_firebase$Native_Authentication.init;
...
var _pairshaped$elm_firebase$Firebase_Database_Types$Database = {ctor: 'Database'};
var _pairshaped$elm_firebase$Firebase_Database_Types$Reference = {ctor: 'Reference'};
var _pairshaped$elm_firebase$Firebase_Database_Types$Query = {ctor: 'Query'};
var _pairshaped$elm_firebase$Firebase_Database_Types$Snapshot = {ctor: 'Snapshot'};

var _pairshaped$elm_firebase$Firebase_Database$ref = _pairshaped$elm_firebase$Native_Database.ref;
var _pairshaped$elm_firebase$Firebase_Database$init = _pairshaped$elm_firebase$Native_Database.init;
			...
			var subscribed = function (_p6) {
				...
				return _elm_lang$core$List$isEmpty(
					A2(
						...
						function (_p8) {
							var _p9 = _p8;
							return _elm_lang$core$Native_Utils.eq(_p9._0, _p7._0) && _elm_lang$core$Native_Utils.eq(
								_pairshaped$elm_firebase$Firebase_Database_Reference$toString(_p9._1),
								_pairshaped$elm_firebase$Firebase_Database_Reference$toString(_p7._1));
						},
						newSubs));
			};
			...
			var notSubscribed = function (_p10) {
				...
				return _elm_lang$core$List$isEmpty(
					A2(
						...
						function (_p12) {
							var _p13 = _p12;
							return _elm_lang$core$Native_Utils.eq(_p13._0, _p11._0) && _elm_lang$core$Native_Utils.eq(
								_pairshaped$elm_firebase$Firebase_Database_Reference$toString(_p13._1),
								_pairshaped$elm_firebase$Firebase_Database_Reference$toString(_p11._1));
						},
						oldState.subs));
			};
...
var _pairshaped$elm_firebase$Firebase_Database_Snapshot$prevKey = _pairshaped$elm_firebase$Native_Database_Snapshot.prevKey;
var _pairshaped$elm_firebase$Firebase_Database_Snapshot$value = _pairshaped$elm_firebase$Native_Database_Snapshot.value;
var _pairshaped$elm_firebase$Firebase_Database_Snapshot$numChildren = _pairshaped$elm_firebase$Native_Database_Snapshot.numChildren;
var _pairshaped$elm_firebase$Firebase_Database_Snapshot$hasChildren = _pairshaped$elm_firebase$Native_Database_Snapshot.hasChildren;
var _pairshaped$elm_firebase$Firebase_Database_Snapshot$hasChild = _pairshaped$elm_firebase$Native_Database_Snapshot.hasChild;
var _pairshaped$elm_firebase$Firebase_Database_Snapshot$getPriority = _pairshaped$elm_firebase$Native_Database_Snapshot.getPriority;
var _pairshaped$elm_firebase$Firebase_Database_Snapshot$exportVal = _pairshaped$elm_firebase$Native_Database_Snapshot.exportVal;
var _pairshaped$elm_firebase$Firebase_Database_Snapshot$exists = _pairshaped$elm_firebase$Native_Database.exists;
var _pairshaped$elm_firebase$Firebase_Database_Snapshot$child = _pairshaped$elm_firebase$Native_Database_Snapshot.child;
...
var _pairshaped$elm_firebase$Main$initialDatabaseURL = 'https://elm-firebase-ca259.firebaseio.com';
var _pairshaped$elm_firebase$Main$initialApiKey = 'AIzaSyAKyWsMVcQZwnW3CKkcasyejfDEE7aMLmo';
var _pairshaped$elm_firebase$Main$initialModel = {
	config: {apiKey: _pairshaped$elm_firebase$Main$initialApiKey, authDomain: '', databaseURL: _pairshaped$elm_firebase$Main$initialDatabaseURL, storageBucket: '', messagingSenderId: ''},
	app: _elm_lang$core$Maybe$Nothing,
	path: _elm_lang$core$Maybe$Nothing,
	reference: _elm_lang$core$Maybe$Nothing,
	latestSnapshot: '',
	child: '',
	value: ''
};
var _pairshaped$elm_firebase$Main$init = {ctor: '_Tuple2', _0: _pairshaped$elm_firebase$Main$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
var _pairshaped$elm_firebase$Main$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {config: a, app: b, path: c, reference: d, latestSnapshot: e, child: f, value: g};
	});
var _pairshaped$elm_firebase$Main$NoOp = function (a) {
	return {ctor: 'NoOp', _0: a};
};
var _pairshaped$elm_firebase$Main$SetChildValue = {ctor: 'SetChildValue'};
var _pairshaped$elm_firebase$Main$ChangeValue = function (a) {
	return {ctor: 'ChangeValue', _0: a};
};
var _pairshaped$elm_firebase$Main$ChangeChild = function (a) {
	return {ctor: 'ChangeChild', _0: a};
};
var _pairshaped$elm_firebase$Main$viewUpdate = function (model) {
	return A2(
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$textarea,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$value(model.latestSnapshot),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$for('child'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Child path: '),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('child'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_pairshaped$elm_firebase$Main$ChangeChild),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(model.child),
												_1: {ctor: '[]'}
											}
										}
									},
					...
					_1: {
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$for('value'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('New value (strings/empties only): '),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('value'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_pairshaped$elm_firebase$Main$ChangeValue),
												_1: {
													ctor: '::',
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_pairshaped$elm_firebase$Main$SetChildValue),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Set child value'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
...
var _pairshaped$elm_firebase$Main$UpdatedSnapshot = function (a) {
	return {ctor: 'UpdatedSnapshot', _0: a};
};
var _pairshaped$elm_firebase$Main$SetPathReference = {ctor: 'SetPathReference'};
var _pairshaped$elm_firebase$Main$update = F2(
	function (msg, model) {
		update:
		while (true) {
			var _p0 = msg;
			switch (_p0.ctor) {
				case 'ChangeApiKey':
					var config = function (prevConfig) {
						return _elm_lang$core$Native_Utils.update(
							prevConfig,
							{apiKey: _p0._0});
					};
				...
				case 'SetApplication':
					var app = _pairshaped$elm_firebase$Firebase$init(model.config);
					var nextModel = _elm_lang$core$Native_Utils.update(
						model,
						{
							app: _elm_lang$core$Maybe$Just(app),
							path: _elm_lang$core$Maybe$Nothing,
							child: '',
							value: ''
						});
					var _v1 = _pairshaped$elm_firebase$Main$SetPathReference,
						_v2 = nextModel;
					msg = _v1;
					model = _v2;
					continue update;
				case 'UnsetApplication':
					var _p1 = model.app;
					if (_p1.ctor === 'Nothing') {
						...
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{app: _elm_lang$core$Maybe$Nothing, path: _elm_lang$core$Maybe$Nothing, child: '', value: ''}),
							_1: A2(
								_elm_lang$core$Task$perform,
								_pairshaped$elm_firebase$Main$NoOp,
								_pairshaped$elm_firebase$Firebase$deinit(_p1._0))
						};
					}
				case 'ChangePath':
					var _p2 = _p0._0;
					var nextPath = _elm_lang$core$Native_Utils.eq(_p2, '') ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_p2);
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
						...
						if (_p3.ctor === 'Just') {
							return _elm_lang$core$Maybe$Just(
								A2(
									...
									model.path,
									_pairshaped$elm_firebase$Firebase_Database$init(_p3._0)));
						} else {
							return _elm_lang$core$Maybe$Nothing;
						}
					}();
				...
				case 'UpdatedSnapshot':
					var latestSnapshot = A2(
				...
				case 'SetChildValue':
					var value = _elm_lang$core$Native_Utils.eq(model.value, '') ? _elm_lang$core$Json_Encode$null : _elm_lang$core$Json_Encode$string(model.value);
					var command = function () {
						var _p4 = model.reference;
						if (_p4.ctor === 'Just') {
							return A2(
								_elm_lang$core$Task$perform,
								_pairshaped$elm_firebase$Main$NoOp,
								A2(
									...
									value,
									A2(_pairshaped$elm_firebase$Firebase_Database_Reference$child, model.child, _p4._0)));
						} else {
...
var _pairshaped$elm_firebase$Main$ChangePath = function (a) {
	return {ctor: 'ChangePath', _0: a};
};
var _pairshaped$elm_firebase$Main$viewPath = function (model) {
	var path = A2(_elm_lang$core$Maybe$withDefault, '', model.path);
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Set database root path'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$for('path'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Root path (can be blank): '),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('path'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_pairshaped$elm_firebase$Main$ChangePath),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(path),
												_1: {ctor: '[]'}
											}
										}
									},
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_pairshaped$elm_firebase$Main$SetPathReference),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
						...
						_1: {
							ctor: '::',
							_0: _pairshaped$elm_firebase$Main$viewUpdate(model),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _pairshaped$elm_firebase$Main$UnsetApplication = {ctor: 'UnsetApplication'};
var _pairshaped$elm_firebase$Main$SetApplication = {ctor: 'SetApplication'};
var _pairshaped$elm_firebase$Main$ChangeDatabaseURL = function (a) {
	return {ctor: 'ChangeDatabaseURL', _0: a};
};
var _pairshaped$elm_firebase$Main$ChangeApiKey = function (a) {
	return {ctor: 'ChangeApiKey', _0: a};
};
var _pairshaped$elm_firebase$Main$view = function (model) {
	var _p5 = model.app;
	if (_p5.ctor === 'Nothing') {
		var disableSetApplication = _elm_lang$core$String$isEmpty(model.config.apiKey) && _elm_lang$core$String$isEmpty(model.config.databaseURL);
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Firebase Config'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$for('firebase-api-key'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Api Key: '),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('firebase-api-key'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onInput(_pairshaped$elm_firebase$Main$ChangeApiKey),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$value(model.config.apiKey),
												_1: {ctor: '[]'}
											}
										}
									},
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$for('firebase-database-url'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Database URL: '),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('firebase-database-url'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_pairshaped$elm_firebase$Main$ChangeDatabaseURL),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$value(model.config.databaseURL),
													_1: {ctor: '[]'}
												}
											}
										},
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_pairshaped$elm_firebase$Main$SetApplication),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$disabled(disableSetApplication),
												_1: {ctor: '[]'}
											}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Connect to firebase app'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], 'Api Key: ', model.config.apiKey)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									A2(_elm_lang$core$Basics_ops['++'], 'Database URL: ', model.config.databaseURL)),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(_pairshaped$elm_firebase$Main$UnsetApplication),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Disconnect from firebase app'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: _pairshaped$elm_firebase$Main$viewPath(model),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _pairshaped$elm_firebase$Main$main = function () {
	var subscriptions = function (model) {
		var _p6 = model.reference;
		if (_p6.ctor === 'Just') {
			return _elm_lang$core$Platform_Sub$batch(
				{
					ctor: '::',
					_0: A3(_pairshaped$elm_firebase$Firebase_Database_Reference$on, 'value', _p6._0, _pairshaped$elm_firebase$Main$UpdatedSnapshot),
					_1: {ctor: '[]'}
				});
		} else {
			return _elm_lang$core$Platform_Sub$none;
	...
	return _elm_lang$html$Html$program(
		{init: _pairshaped$elm_firebase$Main$init, update: _pairshaped$elm_firebase$Main$update, subscriptions: subscriptions, view: _pairshaped$elm_firebase$Main$view});
}()();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _pairshaped$elm_firebase$Main$main !== 'undefined') {
    _pairshaped$elm_firebase$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Firebase.Database.Types.Snapshot":{"args":[],"tags":{"Snapshot":[]}},"Main.Msg":{"args":[],"tags":{"SetApplication":[],"ChangeDatabaseURL":["String"],"SetChildValue":[],"ChangeChild":["String"],"SetPathReference":[],"ChangeValue":["String"],"ChangePath":["String"],"UnsetApplication":[],"NoOp":["()"],"ChangeApiKey":["String"],"UpdatedSnapshot":["Firebase.Database.Types.Snapshot"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
