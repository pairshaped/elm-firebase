...
var _mrozbarry$elm_firebase$Firebase$options = _mrozbarry$elm_firebase$Native_Firebase.options;
var _mrozbarry$elm_firebase$Firebase$name = _mrozbarry$elm_firebase$Native_Firebase.name;
var _mrozbarry$elm_firebase$Firebase$initWithName = _mrozbarry$elm_firebase$Native_Firebase.initWithName;
var _mrozbarry$elm_firebase$Firebase$init = _mrozbarry$elm_firebase$Native_Firebase.init;
var _mrozbarry$elm_firebase$Firebase$apps = _mrozbarry$elm_firebase$Native_Firebase.apps;
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							...
							'Firebase ',
							A2(_elm_lang$core$Basics_ops['++'], _mrozbarry$elm_firebase$Firebase$sdkVersion, ' basic api test'))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					{ctor: '[]'},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								'App.name = ',
								_mrozbarry$elm_firebase$Firebase$name(model.app))),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
							...
							_0: _elm_lang$html$Html$text(
								A2(
									...
									_elm_lang$core$Basics$toString(
										_mrozbarry$elm_firebase$Firebase$options(model.app)))),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: _elm_lang$html$Html$text(
									A2(
										_elm_lang$core$Basics_ops['++'],
										'Number of firebase apps = ',
										_elm_lang$core$Basics$toString(
											_elm_lang$core$List$length(
												_mrozbarry$elm_firebase$Firebase$apps(
													{ctor: '_Tuple0'}))))),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
...
var _mrozbarry$elm_firebase$Main$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _mrozbarry$elm_firebase$Main$init,
		update: _mrozbarry$elm_firebase$Main$update,
		subscriptions: function (model) {
			return _elm_lang$core$Platform_Sub$none;
		},
		view: _mrozbarry$elm_firebase$Main$view
	})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (apiKey) {
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _mrozbarry$elm_firebase$Main$main !== 'undefined') {
    _mrozbarry$elm_firebase$Main$main(Elm['Main'], 'Main', undefined);
}
